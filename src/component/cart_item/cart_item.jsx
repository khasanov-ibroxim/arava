...
const CartItem = () => {
    ...
    const {getProductsForCart, single_basket_products, addToCart, single_basket_data , getSingleBasket , decrementCart} = useBasketStore();
                                        ...
                                        <div className={"shop_product_box"} key={index}>
                                            ...
                                            >
                                                ...
                                                <div className="shop_product_text">
                                                    <h3>{product.name}</h3>
                                                    <p className="product_price"> so'm</p>
                                                </div>
                                            </div>
                                        </div>
                                    )

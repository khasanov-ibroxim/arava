        ...
        <div className="no_data container">
            <div className="empty-cart">
                ...
                <svg viewBox="656 573 264 182" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <rect id="bg-line" stroke="none" fill-opacity="0.2" fill="#3D43CF" fill-rule="evenodd" x="656"
                          y="624" width="206" height="38" rx="19"></rect>
                    <rect id="bg-line" stroke="none" fill-opacity="0.2" fill="#3D43CF" fill-rule="evenodd" x="692"
                          y="665" width="192" height="29" rx="14.5"></rect>
                    <rect id="bg-line" stroke="none" fill-opacity="0.2" fill="#3D43CF" fill-rule="evenodd" x="678"
                    ...
                    <polygon id="plus" stroke="none" fill="#00067c" fill-rule="evenodd"
                    ...
                    <circle id="oval" stroke="#3D43CF" stroke-width="2" fill="none" cx="681" cy="751" r="3"></circle>
